...
import com.nikita_zayanchkovskij.newsapp.databinding.ScienceNewsFragmentBinding
...
import com.nikita_zayanchkovskij.newsapp.presentation.view_model.news_lists_for_main_screen.ScienceNewsViewModel
import kotlinx.coroutines.flow.collectLatest
import kotlinx.coroutines.launch


class ScienceNewsFragment: Fragment(), ISetDetailedNewsInfoToViewModel {
    private lateinit var binding: ScienceNewsFragmentBinding
    private val scienceNewsViewModel: ScienceNewsViewModel by activityViewModels()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = ScienceNewsFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setUpRecyclerViewAdapter() = with(binding) {
        rcViewScienceNews.layoutManager = LinearLayoutManager(activity as AppCompatActivity)
        rcViewScienceNews.adapter = newsAdapter
    }


    private fun receiveNewsData() {
        lifecycleScope.launch {
            scienceNewsViewModel.receiveScienceNews()
        }
    }
    ...
    private fun observeNewsData() {
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                scienceNewsViewModel.scienceNewsList.collectLatest { newsListState ->
